        ...
        <div className="wrapper fade-in">
            ...
            <div className="kindwords-container">
                <div className="kindwords-row kindwords-right">
                    ...
                    <img className="image-size" src={require("../../assets/images/MelinaBen.jpg").default}></img>
                </div>
                <div className="kindwords-row kindwords-left">
                    ...
                    <img className="image-size" src={require("../../assets/images/MateoCass.jpg").default}></img>
                </div>
            </div>
        </div>
    )
